...
/*
    Другой Вариант со строковой рекурсией
*/
/**/
string NumRec1(int n)
{
    if (n == 0)
        return "";
    else
        return NumRec1(n - 1) + $"{n}, ";
}
/**/
void NumRec2(int n, int a = 1)
{
    if (a > n) return;
...
/**/
Console.WriteLine("NumRec0:");
NumRec0(n);
Console.WriteLine();
Console.WriteLine("NumRec1:");
Console.WriteLine(NumRec1(n));
Console.WriteLine("NumRec2:");
NumRec2(n);
/**/
/*
===============================================================================================================================
